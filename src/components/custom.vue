...
<!--    <div id="echart2" style="width: 600px;height:400px;"></div>-->
        <div id="echart3" style="width: 2000px;height:600px;"></div>
  </div>
</template>
  ...
  methods: {
    ...
    prom1 () {
      ...
      axios.get(url).then(response => {
        ...
        this.promData = response.data.data.result[0].values
        this.promData.forEach(function (el) {
          // el[0] = this.getTime(el[0])
